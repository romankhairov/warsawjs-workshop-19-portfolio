...
$form.addEventListener('submit', function (evt) {
    // 9. listening for Submit

    evt.preventDefault(); // 10. Turn off defoult form acting

    var data = new FormData($form); // 11. Var, that keeps form input data

    var map = new Map(data); // 12. Convert input form data into map
...
//# sourceMappingURL=/main.c88d0d65.map